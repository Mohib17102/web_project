...
<body>
	<?php 	include("header.php"); 
		...
		{	
			$qry=mysqli_query($conn,"insert into `add_party`(`id`,`party_title`)value('','$party_title')");
...
<a href="add_data.php"><span class="glyphicon glyphicon-arrow-left "> Back</span></a></p>
    	        <div class="col-md-10">
            		<div class="row">
    				        ...
    				        <div class="col-md-8">
<p style="color:#367608; font-weight:bold; font-size:24px; font-family:Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif; margin-left:165px"> <b>Add Party</b></p>
<hr/>
		<form method="post" enctype="multipart/form-data" onSubmit="return services()">
			<table border="0" width="90%" height="auto">
                <tr>
	                <td width="20%"><h4>Party Name</h4></td>
    	            <td><input type="text" name="party_title"  class="form-control" id="names">
               <p id="ntitle" style="color:#F5060A;font-size:18px;text-transform:capitalize;margin-top:10px"></p>     
                ...
                <tr>
                     <td></td>
                     <td><input type="submit" name="submit"  value="Add Party" class="btn-success btn-lg" >
	<?php
			if($qry)
		{
	?>	
	...
	<?php 
		$qry=mysqli_query($conn,"select * from  `add_party`");
		$sno= 1; 
	...
	?>
				<tr align="center">
       				<td><?php echo $sno++; ?>  </td>
                    <td><?php echo $row['party_title']; ?></td>
                  
                               <td align="center">
                    <a href="update.php?peid=<?php echo $row['id']; ?>"><button class="btn btn-info glyphicon glyphicon-edit">&nbsp;Update</button></a></td>
                    <td align="center">
                    <a href="delete.php?pid=<?php echo $row['id']; ?>"><button class="btn btn-danger glyphicon glyphicon-trash ">&nbsp;Delete</button></a></td> 
                </tr>
	<?php } ?>
			</table> -->
				</div>
