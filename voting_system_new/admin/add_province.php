...
<a href="address_data.php"><span class="glyphicon glyphicon-arrow-left "> Back</span></a></p>
    	        <div class="col-md-10">
            		<div class="row">
    				        ...
    				        <div class="col-md-8">
<p style="color:#367608; font-weight:bold; font-size:24px; font-family:Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif; margin-left:165px"> <b>Add Province</b></p>
<hr/>
		<form method="post" enctype="multipart/form-data" onSubmit="return services()">
			<table border="0" width="90%" height="auto">
                <tr>
	                <td width="20%"><h4>Province Name</h4></td>
             ...
             <tr><td></td><td><input type="hidden" name="address_type" value="province" class="form-control" id="names" >
               <p id="ntitle" style="color:#F5060A;font-size:18px;text-transform:capitalize;margin-top:10px"></p>     
                    </td></tr>
                <tr>
                     <td></td>
	...
	<?php 
		$qry=mysqli_query($conn,"select * from  `address_data` where `address_type`='province'");
		$sno= 1; 
	...
	?>
				<tr align="center">
                    ...
                    <td><?php echo $row['address_type']; ?></td>
                               ...
                               <td align="center">
                    <a href="update.php?preid=<?php echo $row['id']; ?>"><button class="btn btn-info glyphicon glyphicon-edit">&nbsp;Update</button></a></td>
                    <td align="center">
                    <a href="delete.php?prid=<?php echo $row['id']; ?>"><button class="btn btn-danger glyphicon glyphicon-trash ">&nbsp;Delete</button></a></td> 
                </tr>
	<?php } ?>
			</table> -->
				</div>
