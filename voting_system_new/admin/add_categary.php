...
<body>
	<?php 	include("header.php"); 
			...
			{
			$categary_title=$_POST['categary_title'];
			
		
			if(!empty($categary_title))
			
		{	
			$qry=mysqli_query($conn,"insert into `add_categary` (`id`,`categary_title`)value('','$categary_title')");
...
<a href="add_data.php"><span class="glyphicon glyphicon-arrow-left "> Back</span></a></p>

    	        <div class="col-md-10">
            		<div class="row">
       					 <div class="col-md-2"></div>
    				        <div class="col-md-8">
<p style="color:#367608; font-weight:bold; font-size:24px; font-family:Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif; margin-left:165px"> <b>Add Categary</b></p>
<hr/>
		<form method="post" enctype="multipart/form-data" onSubmit="return services()">
			<table border="0" width="90%" height="auto">
                <tr>
	                <td width="20%"><h4>Categary Title</h4></td>
    	            <td><input type="text" name="categary_title"  class="form-control" id="names">
			...
			<div class="col-md-12">
				<!-- <table border="1" width="90%" height="auto" align="center">
					<tr align="center" bgcolor="#565250" style="color:white;font-weight:bold" height="50">
                       <td>S.No</td>
                       <td>Categary Title</td>
                      
                  
                       <td colspan="2" width="20%">Opreation</td>
                   </tr>
	<?php 
		$qry=mysqli_query($conn,"select * from  `add_categary`");
		$sno= 1; 
	...
	?>
				<tr align="center">
       				<td><?php echo $sno++; ?>  </td>
                    <td><?php echo $row['categary_title']; ?></td>
                  
                               <td align="center">
                    <a href="update.php?seid=<?php echo $row['id']; ?>"><button class="btn btn-info glyphicon glyphicon-edit">&nbsp;Update</button></a></td>
                    <td align="center">
                    <a href="delete.php?sid=<?php echo $row['id']; ?>"><button class="btn btn-danger glyphicon glyphicon-trash ">&nbsp;Delete</button></a></td> 
                </tr>
	<?php } ?>
			</table> -->
				</div>
