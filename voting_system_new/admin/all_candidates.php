...
<?php	include("header.php");
 ...
 <div class="col-md-2"><?php include("menu.php"); ?></div>
        ...
        <p style="color:#367608; font-weight:bold; font-size:24px; font-family:Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', serif;text-align:center"> <b>All Candidates</b></p>
<hr/>
...
<div class="col-md-4" style="border:1px solid;margin-left:0px;margin-bottom: 10px;background-color: silver;height: 400px">
	<div id="image_area">
  		<img src="<?php  echo $row['candidate_image'];?>" width="90%" height="100%" style="margin:5%;border:1px solid" class="img-round"  />
    </div>
    <div id="image_area">
  		<img src="<?php  echo $row['party_logo'];?>" width="90%" height="100%" style="margin:5%;border:1px solid" class="img-round"  />
    </div>
